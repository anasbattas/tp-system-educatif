...
public class SupprimerDepartement extends Application {
    ...
    private ObservableList<departement> itemList;
    private ListView<departement> listView;
    ...
    private void loadItemsFromDatabase() {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl, username, password)) {
            String query = "SELECT intitule, responsable FROM departement";
            try (Statement statement = connection.createStatement()) {
                ...
                while (resultSet.next()) {
                  ...
                  String responsable = resultSet.getString("Responsable");
                    departement item = new departement( intitule, responsable );
                    itemList.add(item);
                }
            }
    ...
    private void deleteSelectedItem() {
      ...
      departement selectedItem = listView.getSelectionModel().getSelectedItem();
    ...
    private void deleteItemFromDatabase(String intitule) {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl, username, password)) {
            String query = "DELETE FROM departement WHERE intitule = ?";
    ...
    public static class departement {
        ...
        public departement(String intitule,String responsable) {
